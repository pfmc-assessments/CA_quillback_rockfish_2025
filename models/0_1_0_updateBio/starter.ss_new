...
#C file write time: 2025-03-12  08:58:16
...
-1 # min year for sdreport outputs (-1 for styr); #_1914
-2 # max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2036
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1741795147
