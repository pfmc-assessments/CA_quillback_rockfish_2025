...
output <- utils::read.csv('U:/Stock assessments/CA_quillback_rockfish_2025/models/0_0_1_2021base/ca_qlbk_std_output.csv') 
...
#| echo: false
#| warning: false
a <- knitr::knit_child('04f_model-sensitivity.qmd', quiet = TRUE)
cat(a, sep = '\n')
```
