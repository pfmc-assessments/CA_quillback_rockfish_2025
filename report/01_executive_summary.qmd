...
During the last 10 years when `r spp` in California was managed within the Minor Nearshore Rockfish complex, the total removals were above the species' \gls{ofl} contribution from 2015--2022. Since 2023, `r spp` in California have been managed individually but did not have species-specific reference points. Total removals were above the \gls{ofl} contribution in 2023 but below the \gls{ofl} contribution for 2024 (@tbl-es-management). 
