...
During the last 10 years, while `r spp` in California was managed within the minor Nearshore Stock complex, the total removals were above the species' \gls{ofl} contribution from 2015--2022. Since 2023, `r spp` has had its own reference points and attainment was below the OFL for 2024 (@tbl-es-management). 
