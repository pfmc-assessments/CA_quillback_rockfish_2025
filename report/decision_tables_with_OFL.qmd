...
mod_low_A <- r4ss::SS_output(here::here("models/6_0_2_postStarBase_sigma075_low_M_pstar_0.45"), printstats = FALSE, verbose = FALSE, SpawnOutputLabel = "Spawning output (billions of eggs)")
mod_high_A <- r4ss::SS_output(here::here("models/6_0_2_postStarBase_sigma075_high_M_pstar_0.45"), printstats = FALSE, verbose = FALSE,  SpawnOutputLabel = "Spawning output (billions of eggs)")
mod_base_A <- r4ss::SS_output(here::here("models/6_0_2_postStarBase_sigma075"), printstats = FALSE, verbose = FALSE, SpawnOutputLabel = "Spawning output (billions of eggs)")
...
#| message: false
#| eval: true
#| fig-cap: "OFLs and assumed catch for management scenario A: the default harvest control rule $P$* = 0.45 and sigma = 0.5."
...
#| message: false
#| eval: true
#| fig-cap: "OFLs and assumed catch for management scenario B: the default harvest control rule $P$* = 0.40 and sigma = 0.5."
#knitr::include_graphics(
#  file.path("OFL_timeseries_for_states_of_nature_stream_B.png")
#)
