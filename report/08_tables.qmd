...
#| echo: false
#| warning: false
#| tbl-cap: "Summary of the number of age samples available for use in the assessment model as conditional age at length data for the growth fleet. See text for description of data sources. Only ages from Abrams were ultimately used in the assessment model for the growth fleet. Ages from CCFRP were used in the assessment model for the CCFRP fleet. For both cases, the number of ages was used as the input sample size."
