...
#| echo: false
#| warning: false
#| tbl-cap: "Summary of the number of commercial length samples and number of trips available for use in the stock assessment. Also included is the input sample size used in the assessment following the formula described in the text."
