...
#| echo: false
#| warning: false
#| tbl-cap: "Summary of the number of age samples available (except commercial). See text for description of data sources. All data were used in the external estimate of growth. Only ages from Abrams were used in the assessment model as conditional age-at-length for the growth fleet. Ages from CCFRP were used in the assessment model as conditional age-at-length for the CCFRP survey fleet. For Abrams and CCFRP, the number of ages was used as the input sample size."
