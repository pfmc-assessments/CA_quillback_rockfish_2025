...
cols_label(
    ...
    Abrams_Nfish = "Abrams",
    trawl_Nfish = "WCGBTS",
    CCFRPFarallons_Nfish = "CCFRP \n Farallons",
    CCFRPNotFarallons_Nfish = "CCFRP Other",
    Comm2019_Nfish = "Comm",
    CRFS_Nfish = "CRFS",
    Cooperative_Nfish = "SWFSC Coop",
    SWFSCResearch_Nfish = "SWFSC Research",
    RBG_Nfish = "Surrendered",
    IPHC_Nfish = "IPHC",
    misc = "Misc."
  ) |>
  as_latex()
...
```{r}
#| label: tbl-sens-biology
#| warning: false
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to biology. See main text for details on each sensitivity analysis."
#| tbl-pos: H
# table_sens(here::here("report/tables/sens_biology_table.csv"))
sens <- read.csv(here::here("report/tables/sens_biology_table.csv"), check.names = FALSE)
sens |>
  gt() |>
  tab_options(
    table.font.size = 12,
...
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to productivity. See main text for details on each sensitivity analysis."
#| tbl-pos: H
...
```{r}
#| label: tbl-sens-leaveOut
#| warning: false
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to leaving out data sources. See main text for details on each sensitivity analysis."
#| tbl-pos: H
#table_sens(here::here("report/tables/sens_leaveOut_table.csv"))
sens <- read.csv(here::here("report/tables/sens_leaveOut_table.csv"), check.names = FALSE)
sens |>
  gt() |>
  tab_options(
    table.font.size = 12,
...
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to alternative data choices. See main text for details on each sensitivity analysis."
#| tbl-pos: H
...
```{r}
#| label: tbl-sens-weighting
#| warning: false
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to data weighting. See main text for details on each sensitivity analysis."
#| tbl-pos: H
#table_sens(here::here("report/tables/sens_leaveOut_table.csv"))
sens <- read.csv(here::here("report/tables/sens_leaveOut_table.csv"), check.names = FALSE)
sens |>
...
#| echo: false
#| eval: !expr eval_tables 
#| tbl-cap: "Number of parameters, values of log-likelihood, estimates of key parameters, and estimates of derived quantities between the base model and several alternative models (columns) relative to selectivity. See main text for details on each sensitivity analysis."
#| tbl-pos: H
...
#| echo: false
#| warning: false
#| tbl-cap: "Risk Table for California `r spp` to document ecosystem and environmental factors, as well as data driven factors potentially affecting stock productivity and uncertainty or other concerns arising from the stock assessment. Level 1 is a favorable ranking, Level 2 neutral, and Level 3 unfavorable."
