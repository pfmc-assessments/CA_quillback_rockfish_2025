...
#| fig-alt: "Line plot showing mean length along with uncertainty in each year with a declining trend in mean length from 1980 to 1995 and slowing increasing trend to 2015."
...
#| fig-alt: "Scatter plot of the available weight and length data for quillback rockfish and a line with the fitted curve, showing an exponential increase of increasing weight at length."
...
#| fig-alt: "Scatter plot of the available maturity at length data for quillback rockfish and a solid line representing the estimated functional maturity."
...
#| fig-alt: "Scatter plot of the available fecundity at length data with the fitted relationship."
