...
#| warning: false
#| eval: true
#| fig-cap: "Total removals (mt) for quillback rockfish in California from 1916-2024 for the commercial (blue bars; CA_Commercial) and recreational (red bars; CA_Recreational) fleets. The y-axis units are metric tons."
