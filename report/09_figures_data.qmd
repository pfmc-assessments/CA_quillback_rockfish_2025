...
#| warning: false
#| eval: true
#| fig-cap: "Available length-at-age data for the 2025 stock assessment. Growth curves are provided based on the external estimate of the data, from the internally estimated values within the base model. The fixed values from the 2021 assessment are also provided for comparison."
