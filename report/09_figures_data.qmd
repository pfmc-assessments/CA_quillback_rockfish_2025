...
#| warning: false
#| eval: true
#| fig-cap: "Mean length for the the CCFRP survey with 95 percent confidence intervals based on current samples sizes."
...
#| warning: false
#| eval: true
#| fig-cap: "Mean length for the the ROV survey with 95 percent confidence intervals based on current samples sizes."
#| fig-alt: "Line plot showing mean length along with uncertainty in each year with a generally unchange pattern, though lengths are larger in 2014 and 2015, and show and increasing trend from 2019 to 2021."
