...
#| fig-alt: "A five panel plot with each showing year on the x-axis and average CPUE on the y-axis.  The average CPUE is plotted for each of the sampling locations.  There is little trend information in the data from Bodega Head, South Cape Mendocino, Stewarts Point and Ten Mile.  The Southeast Farallon Island show an increase in CPUE in 2024."
...
#| fig-alt: "A figure with box plots showing CPUE across depth bins.  The median CPUE is similar across all depths from 40 to 200 feet."
...
#| fig-alt: "The QQ plot shows a fit close to the one to one line from 500 simulated residuals."
