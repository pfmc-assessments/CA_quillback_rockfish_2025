# Appendix C: California Collaborative Fisheries Research Progam Index of Abundance

The California Collaborative Fisheries Research Program, [\gls(CCFRP)](https://www.mlml.calstate.edu/ccfrp/), is a fishery-independent hook-and-line survey designed to monitor nearshore fish populations at a series of sampling locations both inside and adjacent to MPAs [@starr_variation_2015a; @wendt_collaborative_2009].  The CCFRP survey began in 2007 along the central coast of California and was designed in collaboration with academics, NMFS scientists and fishermen. In 2017, the CCFRP expanded coastwide within California. Quillback rockfish were rarely observed south of the Farallon Islands.  The index represents the MPAs and reference sites from the Farallon Islands and north. 
