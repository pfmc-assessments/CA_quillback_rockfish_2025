...
A total of 736 age reads were available from otoliths collected from `r spp` off the coast of California from 1985--2024 across a variety of sources (@tbl-caal_ages). Ages from \gls{s-ccfrp} and Abrams were used in base model, but the remaining 450 available ages were used in initializing growth parameters and were not included in the base model. The sources of these remaining ages include: 
