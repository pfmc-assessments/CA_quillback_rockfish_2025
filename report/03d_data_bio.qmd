...
This model does not explicitly include envrionmental or ecosystem data.  `r Spp` are a rocky habitat associated species and the area of available habitat was consdiered when developing indices of abundance for the fishery-independent survyes. 
