...
The majority of length-at-age data available for California `r spp` were collected in the last five years. The \gls{ccgs} is the only fishery-dependent sampling program that collects otoliths as part of the sampling design and the majority of other age data are combined into a growth fleet.  External estimates of growth from ages across the range of `r spp` do not indicate sexually dimorphic growth (Claire Stuart, Cal Poly Humboldt, pers. comm.), as also found by @LenarzandEcheverria_dimorphism_1991. A number of the `r spp` collected for biological studies targeted females, and so, combined with lack of evidence for sexual dimorphism, we did not estimate dimorphic growth for the California-specific data. Lengths from age-zero fish (N = 192) were available from a dissertation study [@baetscher_2019_larval] and were only used to inform initial parameters for growth that were estimated external to the base model. Baetscher -@baetscher_2019_larval trapped juvenile rockfish within Monterey Bay using \gls{smurf}s and divers with nets. All of the `r spp` captured were morphologically identified as gopher, copper or kelp rockfish, but were genetically identified as `r spp`. 
