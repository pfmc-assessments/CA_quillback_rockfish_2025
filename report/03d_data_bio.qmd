...
* The \gls{swfsc} Grounfish Cooperative Data Collection program during the 2022 fishing season (N = 134)
* The \gls{swfsc} life history research activities (N = 96) 
* The \gls{cdfw} collected `r spp` otoliths from commercial (N = 6) and recreational private/rental (N = 111) vessels, and from fish surrendered to \gls{crfs} samplers (N = 55). 
