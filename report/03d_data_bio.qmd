...
The fixed growth parameters from the 2021 stock assessment differ from those estimated externally from the available data in 2025 (@fig-growthdata).
The 2021 assessment used the following parameters for growth

\begin{centering}
$L_{\infty}$ = 43.04 cm; $k$ = 0.199; $t_0$ = -0.067 cm  
\end{centering}
and the 2025 external fit to growth is 
\begin{centering}
$L_{\infty}$ = 41.18 cm; $k$ = 0.177; $t_0$ = -0.620 cm 
\end{centering}
where $L_{\infty}$ is the asympotitic average length,  $k$ is the growth coefficient with units $year^{-1}$, and $t_0$ represents the time when the average lenth was zero. Note that Stock Synthesis typically uses the Schnute parameterization of vonBertalanffy growth. 
