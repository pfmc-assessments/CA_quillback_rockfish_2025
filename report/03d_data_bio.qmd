...
An additional 450 age reads were available from otoliths collected from `r spp` off the coast of California from 1985--2024 across a variety of sources (@tbl-caal_ages). These available ages were used in initializing growth parameters (i.e. in external estimates of growth only), but were not included in the final base model. The sources include: 
...
In addition to these 450 age reads, 192 age-zero fish from Diana Baetscher's dissertation work [@baetscher_2019_larval] trapping young-of-the-year rockfish within Monterey Bay using \gls{smurf}s and divers with nets were also available and used to inform initial parameters for growth. The `r spp` captured were morphologically identified as gopher, copper or kelp rockfish, but were genetically identified as `r spp`. 
