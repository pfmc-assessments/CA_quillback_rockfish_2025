...
External estimates of growth from ages across the range of `r spp` do not indicate sexually dimorphic growth (C. Stuart, Cal Poly Humboldt, pers. comm.), as also found by @LenarzandEcheverria_dimorphism_1991. A number of the `r spp` collected for biological studies targeted females, and so, combined with lack of evidence for sexual dimorphism, we did not estimate dimorphic growth for the California-specific data. 
