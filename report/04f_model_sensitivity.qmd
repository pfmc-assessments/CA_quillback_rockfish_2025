...
-   Full blocking of the recreational and commercial fleets, allowing for dome shaped selectivity. This scenario assumes the greatest number of blocks, and therefore parameters, among all the selectivity scenarios and was based on discussions with \gls{cdfw} staff and advisory panel members from the \gls{gmt} and \gls{gap}. **FROG: Prob just cite the early description of these years earlier in the document** Blocks for the commercial fleet were assumed for 1916--2002, 2003--2013, 2014--2021, and 2022--2024 (due to changes in bag limits and creation of the deeper nearshore permit as well as general depth restrictions in 2003, changes in depth limits for the northern port groups around 2014, and increased depth restrictions starting in 2022). Blocks for the recreational fleet were assumed for 1916--2000, 2001--2016, 2017--2022, and 2023--2024 (due to depth restrictions starting in 2001 and relaxation of those depth restrictions starting in 2017, and due to increase restrictions on harvest and retention of `r spp` starting in 2023).
