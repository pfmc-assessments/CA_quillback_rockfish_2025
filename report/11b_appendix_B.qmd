...
Remotely operated vehicle (ROV) surveys have been used to monitor California’s mid-depth habitats (30-100 m) since 2004.  The surveys are a collaboration between CDFW and Marine Applied Research and Exploration (MARE) which was initially developed to assess the Marine Protected Area (MPA) network.  A full description of survey methods is available in [@lauermann_rov_2017].  Briefly, sampling has been conducted at MPAs along the entire California coast (@fig-ROV-rel-fig1) with 500-meter transects conducted within rocky reef habitat inside and outside each MPA (@fig-ROV-rel-fig2).  Data includes counts of fish by species, fish sizes, and a variety of characteristics of the transect location (@tbl-ROV-rel-tbl1).   
