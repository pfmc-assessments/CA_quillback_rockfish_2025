...
pr_filter <- read.csv("tables/ROV_rel_tbl1.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
...
pr_filter <- read.csv("tables/ROV_rel_tbl2.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
...
pr_filter <- read.csv("tables/ROV_rel_tbl3.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
...
pr_filter <- read.csv("tables/ROV_rel_tbl4.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
...
pr_filter <- read.csv("tables/ROV_rel_tbl5.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
...
pr_filter <- read.csv("tables/ROV_rel_tbl6.csv")
pr_filter |>
    gt() |>
     tab_options(
    table.font.size = 12) |>
