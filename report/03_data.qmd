...
2.  Fishery-dependent length and age composition data were obtained from the following sources:
    a.  Commercial data come from the \gls{ccgs} sampling program in years ranging between 1978--2024 for lengths and 2007--2024 for ages. Data were obtained from \gls{pacfin}.
...
4.  Fishery-independent data, which include length and age composition data and relative abundance trends were obtained from two different surveys:
    ...
    f.  Paired age and length samples collected by Jeff Abrams for his thesis study at Cal Poly Humboldt are included as a growth fleet in the model for internally estimating growth.  
