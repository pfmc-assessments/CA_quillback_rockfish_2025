...
#| fig-alt: "Scatter plot of the ages from readers 1 on the x-axis and reader 2 on the y-axis.  The agreement among readers is reasonable and closer for younger fish.  The 1 to 1 line is alos plotted to show true agreement. There is some positive bias in reader 2 between ages 30 and 40."
...
#| fig-alt: "Spawning output is relatively unfished between the start of the model until the mid 1980s with the spawning output sharply decreasing to low levels by 2000 remaining low until the early 2000s where spawning output begins to increase and then stabilizes towards the end of the time series."
...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of ln(R0) values."
...
#| fig-alt: "Four panel plot with ln(R0) on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a bowl, with the minimum at the estimate of ln(R0). In the other panels, as ln(R0) increases, the spawning output relative to unfished, initial spawning output, and final spawning output all increase as well."
...
#| fig-alt: "Four panel plot with ln(R0) on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model. The length data is the primarily source of information informing the estimate of log(R0) with age data from the growth fleet supporting higher log(R0). There is little information about log(R0) from the survey indices."
...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of steepness values."
...
#| fig-alt: "Four panel plot with steepness on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a declining pattern, with the minimum at higher fixed values of steepness than used for the base model. In the other panels, as steepness increases, the spawning output relative to unfished, and final spawning output increase slightly, and the initial spawning output declines slightly."
...
#| fig-alt: "Four panel plot with steepness values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model, the contribution from age data from each fleet. The length data is the primarily source of information informing the estimate of steepness. There is little information about steepness from the survey indices."
...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of natural mortality values."
...
#| fig-alt: "Four panel plot with natural mortality on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a declining pattern, with the minimum at higher fixed values of natural mortality than used for the base model. In the other panels, as natural mortality increases, the spawning output relative to unfished, initial spawning output, and final spawning output increase."
...
#| fig-alt: "Four panel plot with natural mortality values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model, the contribution from age data from each fleet. The recruitment and recreational length data is the primarily source of information informing the estimate of natural mortality. There is little information about natural mortality from the survey indices."
...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of L infinity values."
...
#| fig-alt: "Four panel plot with asymptotic average length on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a bowl, with the minimum at the estimated value of asymptotic average length. In the other panels, as asymptotic average length increases, the spawning output relative to unfished, and final spawning output increase, while initial spawning output is nearly unchanged."
...
#| fig-alt: "Four panel plot with asymptotic average length values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model, the contribution from age data from each fleet. The length data is the primarily source of information informing the estimate of the asymptotic average length. There is little information about asymptotic average length from the survey indices."
...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of values for the growth coefficient K."
...
#| fig-alt: "Four panel plot with K on the x-axis and values on the y-axis as described in the caption. The likelihood figure reflects a bowl, with the minimum at the estimated value of K. In the other panels, as K increases, the spawning output relative to unfished, and final spawning output increase, while initial spawning output is nearly unchanged."
...
#| fig-alt: "Four panel plot with growth coefficient K values on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model, the contribution from age data from each fleet. The length data is the primarily source of information informing the estimate of the growth coefficient K. There is little information aboutgrowth coefficient K from the survey indices."
...
#| warning: false
#| eval: true
#| fig-cap: "Time series comparisons of summary biomass (in metric tons, top), and spawning output relative to unfished (bottom) with 95% confidence interval from the base model of the 2021 stock assessment and the 2025 base model."
#| fig-alt: "Two panel line plot with years on the x-axis and age-3 biomass in the top panel and fraction unfished in the bottom panel's y-axis.  The time series shows the change in the base model from the 2021 assessment to the 2025 assessment."
...
#| fig-alt: "Time series plot with uncertainty intervals showing fishing intensity above the SPR target of 50 percent in many years from 1980 to 2000, and again from 2015 to 2020."
