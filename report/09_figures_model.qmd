...
#| fig-alt: "Two panels with line plots with year on the x-axis. The lines represent spawning output on the y-axis, top panel, and fraction unfished, bottom panel, for multiple model runs that assume a range of log(R0) values."
...
#| fig-alt: "Change in the estimate of spawning output (billions of eggs, top) and spawning output relative to unfished (bottom) across a range of ln(R~0~) values."
#| fig-alt: "Four panel plot with log(R0) on the x-axis and change in log-likelihood on the y-axis with panels showing the contribution from each data type in the model, the contribution from age data from each fleet. The length data is the primarily source of information informing the estimate of log(R0) with age data from the growth fleet supporting higher log(R0). There is little information about log(R0) from the survey indices."
