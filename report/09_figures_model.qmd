...
#| warning: false
#| eval: true
#| fig-cap: "Retrospective results: change in the estimate of spawning output (in billions of eggs) when the most recent 15 years of data area removed sequentially. The uncertainty shown represents the base model."
