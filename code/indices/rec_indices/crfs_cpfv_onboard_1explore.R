################################################################################
# Contains SQL connections to read the onboard observer data for the 
#              2025 California quillback rockfish assessment
#	
# Melissa Monk 1/30/2025
################################################################################
...
speciesNODC = 8826010120   #quillback NODC number
...
onboard_data <- onboard_data %>%
  ...
  mutate(effort = obsang * (fishtime/60),
